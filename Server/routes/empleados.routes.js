...
router.get('/', checkAuth(["admin", "usuario", "gerente"]), empleadosController.getEmpleados);
router.get('/:id', checkAuth(["admin", "usuario", "gerente"]), empleadosController.getEmpleadoById);
